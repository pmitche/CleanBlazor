...
public record DeleteDocumentTypeCommand(int Id) : ICommand<Result<int>>;

internal class DeleteDocumentTypeCommandHandler : ICommandHandler<DeleteDocumentTypeCommand, Result<int>>
{
